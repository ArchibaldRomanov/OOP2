...
int main() {
    ...
    Counter counter;  // создаём счётчик со значением по умолчанию

    if (answer == "да") {
        std::cout << "Введите начальное значение счётчика: ";
        std::cin >> initialValue;
        counter = Counter(initialValue);  // присваиваем новое значение
    }
    ...
    while (true) {
        ...
        case '=': std::cout << counter.getValue() << std::endl; break;
